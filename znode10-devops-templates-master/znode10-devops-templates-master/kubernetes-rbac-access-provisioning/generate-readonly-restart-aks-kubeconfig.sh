...
# === CONFIG ===
NAMESPACE="znode"
SA_NAME="readonly-restart-sa"
ROLE_NAME="readonly-restart-role"
ROLE_BINDING_NAME="readonly-restart-binding"
SECRET_NAME="${SA_NAME}-token"
KUBECONFIG_FILE="readonly-restart-kubeconfig.yaml"
CONTEXT_NAME="readonly-restart"
