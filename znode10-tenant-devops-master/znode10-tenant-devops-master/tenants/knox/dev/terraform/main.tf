...
resource "kubernetes_config_map" "znode10xapigateway-cp" {
  ...
  data = {
    ...
    NEW_RELIC_LICENSE_KEY                     = var.NEW_RELIC_LICENSE_KEY
    NEW_RELIC_APP_NAME                        = var.NEW_RELIC_APP_NAME_API_GATEWAYS_CP
    NEW_RELIC_LABELS                          = var.NEW_RELIC_LABELS
  }
}
...
resource "kubernetes_config_map" "znode10xapigateways" {
  ...
  data = {
    ...
    SwaggerEndPoints_6_Key                    = var.SwaggerEndPoints_6_Key
    SwaggerEndPoints_6_Config__0__Name        = var.SwaggerEndPoints_6_Config__0__Name
    SwaggerEndPoints_6_Config__0__Version     = var.SwaggerEndPoints_6_Config__0__Version
    SwaggerEndPoints_6_Config__0__Url         = var.SwaggerEndPoints_6_Config__0__Url
    SwaggerEndPoints_6_Config__0__BaseUrl     = var.SwaggerEndPoints_6_Config__0__BaseUrl
    appsettings__ValidateAuthHeader           = var.appsettings__ValidateAuthHeader
    appsettings__EnableBasicAuthorization     = var.appsettings__EnableBasicAuthorization
