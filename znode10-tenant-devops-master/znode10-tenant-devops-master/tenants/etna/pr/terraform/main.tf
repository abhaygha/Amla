...
variable "appsettings__WebhookRequestTimeoutInSeconds" {}
...
variable "appsettings__IsSeparatedQuantityByLineItem" {}
...
resource "kubernetes_config_map" "znode10xapi" {
  ...
  data = {
    ...
    appsettings__IsSeparatedQuantityByLineItem = var.appsettings__IsSeparatedQuantityByLineItem        
    appsettings__PluginApiRootUri             = var.appsettings__PluginApiRootUri
    ...
    appsettings__WebhookRequestTimeoutInSeconds         = var.appsettings__WebhookRequestTimeoutInSeconds
...
resource "kubernetes_config_map" "znode10xwebstore" {
  ...
  data = {
    ...
    REDIS_SENTINEL_MASTER_NAME          = var.REDIS_SENTINEL_MASTER_NAME
    REDIS_SENTINEL_ENABLED              = var.REDIS_SENTINEL_ENABLED
    REDIS_SENTINELS                     = var.REDIS_SENTINELS
