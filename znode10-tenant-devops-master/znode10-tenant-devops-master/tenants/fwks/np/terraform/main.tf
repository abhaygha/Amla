...
variable "Spreedly__SecretKey" {}
variable "Spreedly__SigningSecret" {}
...
resource "kubernetes_config_map" "znode10xpluginspreedly" {
  ...
  data = {
    ...
    Spreedly__SecretKey                       = var.Spreedly__SecretKey
    Spreedly__SigningSecret                   = var.Spreedly__SigningSecret
